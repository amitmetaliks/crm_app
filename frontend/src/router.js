...
const routes = [
	...
	{ path: "/stock-check", name: "StockCheck", component: () => import("./pages/StockCheck.vue") },
	{ path: "/pjp", name: "Pjp", component: () => import("./pages/Pjp.vue") },
	{ path: "/secondary", name: "Secondary", component: () => import("./pages/Secondary.vue") },
