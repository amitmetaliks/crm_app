...
const hi = {
	...
	// ---- Manager dashboard ----
	Business: "कारोबार",
	"Business dashboard": "कारोबार डैशबोर्ड",
	"This month": "इस महीने",
	"30 days": "30 दिन",
	"90 days": "90 दिन",
	invoices: "बिल",
	"of target": "टारगेट का",
	"Top reps": "टॉप रेप",
	"dealers owe money": "डीलरों पर बकाया",
	"Dealers covered": "कवर किए डीलर",
	"Active reps": "सक्रिय रेप",
	competitor: "प्रतिस्पर्धी",
	"Dealers going quiet": "शांत होते डीलर",
	"last bought": "पिछली खरीद",
	"Pending approvals": "मंज़ूरी बाकी",
	"Data may be behind.": "डेटा पुराना हो सकता है।",
	"Sales feed last updated": "बिक्री डेटा अंतिम अपडेट",
	payments: "भुगतान",
	attributed: "जुड़ा हुआ",
	"invoiced under rep codes not linked to an employee, so it is not in this list.": "ऐसे रेप कोड पर बिल हुआ जो किसी कर्मचारी से नहीं जुड़ा, इसलिए इस सूची में नहीं है।",
	// ---- Skip ----
	Skip: "छोड़ें",
	Skipped: "छोड़ा गया",
	Undo: "वापस लें",
	...
	"Order ledger": "ऑर्डर लेजर",
	Paid: "भुगतान हुआ",
	"Part paid": "आंशिक भुगतान",
	Due: "बकाया",
	due: "बकाया",
	paid: "भुगतान",
	"No payment data": "भुगतान जानकारी नहीं",
	"Older orders show no payment because the payment feed starts": "पुराने ऑर्डर में भुगतान नहीं दिख रहा क्योंकि भुगतान डेटा शुरू होता है",
	"They are not necessarily unpaid.": "इसका मतलब यह नहीं कि वे बकाया हैं।",
...
const bn = {
	...
	"of target": "টার্গেটের",
	"Top reps": "শীর্ষ রেপ",
	"dealers owe money": "ডিলারের বকেয়া",
	"Dealers covered": "কভার করা ডিলার",
	"Active reps": "সক্রিয় রেপ",
	competitor: "প্রতিযোগী",
	"Dealers going quiet": "নিষ্ক্রিয় হচ্ছে যে ডিলার",
	"last bought": "শেষ কেনা",
	"Pending approvals": "অনুমোদন বাকি",
	"Data may be behind.": "ডেটা পুরোনো হতে পারে।",
	"Sales feed last updated": "বিক্রয় ডেটা শেষ আপডেট",
	payments: "পেমেন্ট",
	attributed: "যুক্ত",
	"invoiced under rep codes not linked to an employee, so it is not in this list.": "এমন রেপ কোডে বিল হয়েছে যা কোনো কর্মচারীর সাথে যুক্ত নয়, তাই এই তালিকায় নেই।",
	// ---- Skip ----
	Skip: "বাদ দিন",
	Skipped: "বাদ দেওয়া",
	Undo: "ফিরিয়ে নিন",
	...
	"Order ledger": "অর্ডার লেজার",
	Paid: "পরিশোধিত",
	"Part paid": "আংশিক পরিশোধ",
	Due: "বকেয়া",
	due: "বকেয়া",
	paid: "পরিশোধ",
	"No payment data": "পেমেন্ট তথ্য নেই",
	"Older orders show no payment because the payment feed starts": "পুরোনো অর্ডারে পেমেন্ট দেখাচ্ছে না কারণ পেমেন্ট ডেটা শুরু হয়",
	"They are not necessarily unpaid.": "এর মানে এই নয় যে সেগুলি বকেয়া।",
